            ...
            <ul class="nav-items">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-label="Tutorial Categories">
                        ...
                        <li><a href="c.php">C Language</a></li>
            ...
            <div class="right-content">
                <div class="about-me">
                    ...
                    <div class="about-wrapper">
                        <img src="./images/mask.jpg" alt="Your Image" class="passport-img">
                        <div class="about-text">
                            <p>Brief description about yourself. This text wraps around the image and continues on the
                                next line as needed as needed as eneeded as needed ad aballballa...</p>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis, exercitationem
                                illum facere error explicabo velit accusantium quae voluptatem! Odio, obcaecati
                                similique culpa repellendus vitae sunt ducimus dolores optio fuga voluptatem.</p>
                        </div>
                    </div>
